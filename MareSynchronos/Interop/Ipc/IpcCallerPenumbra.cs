        ...
        finally
        {
            if (!penumbraAvailable && !_shownPenumbraUnavailable)
            {
                ...
                _mareMediator.Publish(new NotificationMessage("Penumbra inactive",
                    "Your Penumbra installation is not active or out of date. Update Penumbra and/or the Enable Mods setting in Penumbra to continue to use Hingashi. If you just updated Penumbra, ignore this message.",
