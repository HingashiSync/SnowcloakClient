...
public class SettingsUi : WindowMediatorSubscriberBase
{
    ...
    public SettingsUi(ILogger<SettingsUi> logger,
        ...
        DalamudUtilService dalamudUtilService, AccountRegistrationService registerService) : base(logger, mediator, "Hingashi Settings", performanceCollector)
    {
    ...
    private void DrawFileStorageSettings()
    {
        ...
        UiSharedService.TextWrapped("Hingashi stores downloaded files from paired people permanently. This is to improve loading performance and requiring less downloads. " +
        ...
        ImGui.AlignTextToFramePadding();
        ImGui.TextUnformatted("Monitoring Hingashi Storage Folder: " + (_cacheMonitor.MareWatcher?.Path ?? "Not monitoring"));
        ...
        if (_cacheMonitor.MareWatcher == null || _cacheMonitor.PenumbraWatcher == null)
        {
            ...
            UiSharedService.AttachToolTip("Attempts to resume monitoring for both Penumbra and Hingashi Storage. "
        ...
        else
        {
            ...
            UiSharedService.AttachToolTip("Stops the monitoring for both Penumbra and Hingashi Storage. "
                + "Do not stop the monitoring, unless you plan to move the Penumbra and Hingashi Storage folders, to ensure correct functionality of Hingashi." + Environment.NewLine
        ...
        {
            UiSharedService.ColorTextWrapped("Hint: To free up space when using Hingashi consider enabling the File Compactor", ImGuiColors.DalamudYellow);
        }
        ...
        UiSharedService.AttachToolTip("You normally do not need to do this. THIS IS NOT SOMETHING YOU SHOULD BE DOING TO TRY TO FIX SYNC ISSUES." + Environment.NewLine
            ...
            + "Hingashi's storage is self-clearing and will not surpass the limit you have set it to." + Environment.NewLine
    ...
    private void DrawGeneral()
    {
        ...
        _uiShared.DrawHelpText("This will add Hingashi related right click menu entries in the game UI on paired players.");
        ...
        _uiShared.DrawHelpText("This will add Hingashi connection status and visible pair count in the Server Info Bar.\nYou can further configure this through your Dalamud Settings.");
    ...
    private void DrawServerConfiguration()
    {
        ...
        if (ImGui.BeginTabBar("serverTabBar"))
        {
            ...
            if (ImGui.BeginTabItem("Service Settings"))
            {
                ...
                var isMain = string.Equals(serverName, ApiController.HingashiServer, StringComparison.OrdinalIgnoreCase);
