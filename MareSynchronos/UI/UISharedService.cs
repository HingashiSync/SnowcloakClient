...
public partial class UiSharedService : DisposableMediatorSubscriberBase
{
    ...
    {
        ColorTextWrapped("Note: The storage folder should be somewhere close to root (i.e. C:\\HingashiStorage) in a new empty folder. DO NOT point this to your game folder. DO NOT point this to your Penumbra folder.", ImGuiColors.DalamudYellow);
        ...
        using (ImRaii.Disabled(_cacheMonitor.MareWatcher != null))
        {
            ...
            {
                FileDialogManager.OpenFolderDialog("Pick Hingashi Storage Folder", (success, path) =>
                {
                    if (!success) return;
        ...
        {
            ColorTextWrapped("Your selected directory has files or directories inside that are not Hingashi related. Use an empty directory or a previous storage directory only.", ImGuiColors.DalamudRed);
        }
        ...
        DrawHelpText("The storage is automatically governed by Hingashi. It will clear itself automatically once it reaches the set capacity by removing the oldest unused files. You typically do not need to clear it yourself.");
    }
    ...
    public bool DrawOtherPluginState(bool intro = false)
    {
        ...
        {
            ImGui.TextColored(ImGuiColors.DalamudRed, "You need to install both Penumbra and Glamourer and keep them up to date to use Hingashi.");
            return false;
        }
